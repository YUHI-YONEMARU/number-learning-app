...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>どこまでかぞえられるかな？</title>
        <meta name="description" content="「どこまでかぞえられるかな？」は、子ども向けの数がふえていく様子を視覚的に学べるアプリです。1から999999までカウントでき、音声読み上げやアニメーションで数の変化を見て学べます。" />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="どこまでかぞえられるかな？" />
